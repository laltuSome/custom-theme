        ...
        'fields' => array(
            ...
            array(
             ...
             array(
                'id'       => 'quote-icon',
                'type'     => 'media',
                'title'    => __( 'quote', 'redux-framework-demo' ),
                'subtitle'     => __( 'Upload quote for your website.', 'redux-framework-demo' ),
            ),
 array(
                'id'       => 'app-icon',
                'type'     => 'media',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            array(
                'id'       => 'form-logo',
                'type'     => 'media',
                'title'    => __( 'form logo', 'redux-framework-demo' ),
               
            ),
             array(
                'id'       => 'form-heading',
                'type'     => 'text',
                'title'    => __( 'form heading', 'redux-framework-demo' ),
             ...
             array(
                'id'       => 'form-image',
                'type'     => 'media',
                'title'    => __( 'form Image', 'redux-framework-demo' ),
              ...
              array(
                'id'       => 'form-text',
                'type'     => 'editor',
                'title'    => __( 'form Text', 'redux-framework-demo' ),
                'subtitle'     => __( 'Upload banner Text  for your website.', 'redux-framework-demo' ),
                  'args'    => array(
                    'wpautop'       => false,
                    'media_buttons' => false,
